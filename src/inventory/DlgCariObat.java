...
public final class DlgCariObat extends javax.swing.JDialog {
    ...
    private String[] kodebarang,namabarang,kodesatuan,letakbarang,namajenis,aturan;
    ...
    public DlgCariObat(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row={"K","Jumlah","Kode Barang","Nama Barang","Satuan","Letak Barang","Harga(Rp)","Jenis Obat","Embalase","Tuslah","Stok","Aturan Pakai"};
                        ...
                        try {
                            ...
                            if(tbObat.getValueAt(i,0).toString().equals("true")){
                                ...
                                if(carikapasitas.next()){                                    
                                    ...
                                    psobatsimpan.setDouble(9,Double.parseDouble(tbObat.getValueAt(i,8).toString())+
    ...
    public void tampilobat() {        
        ...
        for(i=0;i<z;i++){
            tabModeobat.addRow(new Object[] {
                pilih[i],jumlah[i],kodebarang[i],namabarang[i],kodesatuan[i],letakbarang[i],harga[i],namajenis[i],eb[i],ts[i],stok[i],aturan[i]
            });
        }
        ...
        try {
            psobat=koneksi.prepareStatement("select databarang.kode_brng, databarang.nama_brng,jenis.nama, databarang.kode_sat,databarang.karyawan,databarang.ralan,databarang.beliluar,"+
                        " databarang.letak_barang,databarang.utama from databarang inner join jenis on databarang.kdjns=jenis.kdjns "+
