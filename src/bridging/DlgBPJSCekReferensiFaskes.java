 ...
 * @author dosen
 */
public final class DlgBPJSCekReferensiFaskes extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgBPJSCekReferensiFaskes(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgBPJSCekReferensiFaskes dialog = new DlgBPJSCekReferensiFaskes(new javax.swing.JFrame(), true);
    ...
    public void tampil(String faskes) {
        ...
        try {
            ...
            String URL = prop.getProperty("URLAPIBPJS")+"/devWSLokalRest/provider/ref/provider/query?nama="+faskes+"&start=0&limit=1000";	
	    ...
	    RestTemplate rest = new RestTemplate();	
            ...
            if(nameNode.path("message").asText().equals("Provider Tidak Ada")){
                JOptionPane.showMessageDialog(rootPane,"Provider Tidak Ada");
                BtnKeluar.requestFocus();
