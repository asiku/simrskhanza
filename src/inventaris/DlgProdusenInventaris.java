 ...
 * @author dosen
 */
public final class DlgProdusenInventaris extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgProdusenInventaris(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Produsen Barang ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(60,80,50))); // NOI18N
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            Map<String, Object> param = new HashMap<>();  
                ...
                Valid.MyReport("rptProdusen.jrxml","report","::[ Data Produsen ]::","select inventaris_produsen.kode_produsen, inventaris_produsen.nama_produsen, inventaris_produsen.alamat_produsen, inventaris_produsen.no_telp,"+
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgProdusenInventaris dialog = new DlgProdusenInventaris(new javax.swing.JFrame(), true);
    ...
    public void isCek(){
        BtnSimpan.setEnabled(var.getinventaris_produsen());
        BtnHapus.setEnabled(var.getinventaris_produsen());
        BtnEdit.setEnabled(var.getinventaris_produsen());
        BtnPrint.setEnabled(var.getinventaris_produsen());
    }
