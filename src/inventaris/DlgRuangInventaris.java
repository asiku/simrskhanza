 ...
 * @author dosen
 */
public class DlgRuangInventaris extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgRuangInventaris(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Ruang Inventaris ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(60,80,50))); // NOI18N
    ...
    private void BtnCariActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCariActionPerformed
        prosesCari("select * from inventaris_ruang where id_ruang like '%"+TCari.getText().trim()+"%' "+
                "or nama_ruang like '%"+TCari.getText().trim()+"%' ");
    ...
    private void BtnAllActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnAllActionPerformed
        prosesCari("select * from inventaris_ruang order by id_ruang");
        emptTeks();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgRuangInventaris dialog = new DlgRuangInventaris(new javax.swing.JFrame(), true);
    ...
    public void tampil() {
        String sql="select * from inventaris_ruang order by id_ruang";
        prosesCari(sql);
    }
    ...
    public void isCek(){
       BtnSimpan.setEnabled(var.getinventaris_ruang());
       BtnHapus.setEnabled(var.getinventaris_ruang());
       BtnEdit.setEnabled(var.getinventaris_ruang());
    }
}
