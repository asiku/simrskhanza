 ...
 * @author dosen
 */
public final class DlgBPJSCekRiwayatPeserta extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgBPJSCekRiwayatPeserta(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgBPJSCekRiwayatPeserta dialog = new DlgBPJSCekRiwayatPeserta(new javax.swing.JFrame(), true);
    ...
    public void tampil(String nomorpeserta) {
        ...
        try {
            ...
            String URL = prop.getProperty("URLAPIBPJS")+"/devWSLokalRest/sep/peserta/"+nomorpeserta;	
