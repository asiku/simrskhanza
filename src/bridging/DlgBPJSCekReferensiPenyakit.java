 ...
 * @author dosen
 */
public final class DlgBPJSCekReferensiPenyakit extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgBPJSCekReferensiPenyakit(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        if(tabMode.getRowCount()==0){
            ...
            Valid.MyReport("rptCariBPJSReferensiDiagnosa.jrxml","report","[ Pencarian Referensi Diagnosa ]",
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgBPJSCekReferensiPenyakit dialog = new DlgBPJSCekReferensiPenyakit(new javax.swing.JFrame(), true);
    ...
    public void tampil(String diagnosa) {
        ...
        try {
            ...
            String URL = prop.getProperty("URLAPIBPJS")+"/devWSLokalRest/diagnosa/ref/diagnosa/"+diagnosa;	
	    ...
	    RestTemplate rest = new RestTemplate();	
            ...
            if(nameNode.path("message").asText().equals("Diagnosa Tidak Ada")){
                JOptionPane.showMessageDialog(rootPane,"Diagnosa Tidak Ada");
                BtnKeluar.requestFocus();
