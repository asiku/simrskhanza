...
public final class DlgKunjunganRanap extends javax.swing.JDialog {
    ...
    public DlgKunjunganRanap(java.awt.Frame parent, boolean modal) {
        ...
        Object[] rowRwJlDr={"No.","Lama","Baru","Nama Pasien","L","P","Alamat","Diagnosa","Ruang"};
        ...
        try {
            ps=koneksi.prepareStatement(
                    "select reg_periksa.no_rawat,reg_periksa.tgl_registrasi,reg_periksa.no_rkm_medis,pasien.nm_pasien,pasien.alamat,pasien.jk,pasien.umur,pasien.tgl_daftar,"+
                    "kamar_inap.kd_kamar,bangsal.nm_bangsal,reg_periksa.almt_pj "+
                    ...
                    "where reg_periksa.status_lanjut='Ranap' and reg_periksa.stts<>'Batal' and reg_periksa.tgl_registrasi between ? and ? and bangsal.nm_bangsal like ? or " +                    
        ...
        try{   
            ...
            while(rs.next()){
                ...
                tabMode.addRow(new Object[]{
                    i,setlama,setbaru,rs.getString("nm_pasien"),umurlk,umurpr,rs.getString("almt_pj"),diagnosa,rs.getString("kd_kamar")+" "+rs.getString("nm_bangsal")
                });                
                i++;
            }
            if(i>=2){
