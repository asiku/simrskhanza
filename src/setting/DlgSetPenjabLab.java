...
public class DlgSetPenjabLab extends javax.swing.JDialog {
    ...
    public DlgSetPenjabLab(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row={"Dokter Pnj Laboratorium","Dokter Pnj Radiologi","Dokter Pnj Hemodialisa"};
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Setup Penanggung Jawab Laborat & Radiologi ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 70, 40))); // NOI18N
        ...
        jLabel13.setText("Dokter Laborat :");
        ...
        jLabel14.setText("Dokter Radiologi :");
        ...
        jLabel15.setText("Dokter Hemodialisa :");
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TDokter.getText().trim().equals("")||kddokter.getText().trim().equals("")){
            ...
            Sequel.menyimpan("set_pjlab","?,?,?","Penanggung Jawab",3,new String[]{
                kddokter.getText(),kddokter2.getText(),kddokter3.getText()
            });
            tampil();
            emptTeks();
        }else if(tabMode.getRowCount()>0){
    ...
    private void BtnSimpanKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnSimpanKeyPressed
        if(evt.getKeyCode()==KeyEvent.VK_SPACE){
            ...
            Valid.pindah(evt,kddokter3,BtnBatal);
        }
    ...
    private void kddokter3KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_kddokter3KeyPressed
        if(evt.getKeyCode()==KeyEvent.VK_PAGE_DOWN){
            ...
            Valid.pindah(evt,kddokter2,BtnSimpan);
        }
