 ...
 * @author dosen
 */
public final class DlgBPJSCekKartu extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgBPJSCekKartu(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgBPJSCekKartu dialog = new DlgBPJSCekKartu(new javax.swing.JFrame(), true);
    ...
    public void tampil(String nomorpeserta) {
        ...
        try {
            ...
            String URL = prop.getProperty("URLAPIBPJS")+"/devWSLokalRest/Peserta/peserta/"+nomorpeserta;	
