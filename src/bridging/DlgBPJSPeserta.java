 ...
 * @author dosen
 */
public final class DlgBPJSPeserta extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgBPJSPeserta(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgBPJSPeserta dialog = new DlgBPJSPeserta(new javax.swing.JFrame(), true);
