...
public class DlgSetAplikasi extends javax.swing.JDialog {
    ...
    public DlgSetAplikasi(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row={"Nama Toko","Alamat Toko","Kota","Propinsi","Aktifkan?","Wallpaper","KontaK","Email","Logo"};
    ...
    private void initComponents() {
        ...
        panelGlass1.setPreferredSize(new java.awt.Dimension(200, 252));
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(Nm.getText().trim().equals("")){
            ...
            Sequel.menyimpan("setting","'"+Nm.getText()+"','"+Almt.getText()+"','"+Kota.getText()+
                             "','"+Propinsi.getText()+"','"+Kontak.getText()+"','"+Email.getText()+"','"+YesNo.getSelectedItem()+"'","Setting",EGb,ELogo);
            tampil();
            emptTeks();
        }else if(tabMode.getRowCount()>0){
    ...
    private void EmailKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_EmailKeyPressed
        Valid.pindah(evt,Kontak,BtnCariLogo);
    ...
    */
    ...
    private void tampil() {
        String sql="select nama_instansi, alamat_instansi, kabupaten, propinsi, aktifkan, wallpaper,kontak,email,logo from setting";
        prosesCari(sql);
    }
        ...
        if(row!= -1){
            ...
            try {
                ResultSet hasil = koneksi.createStatement().executeQuery(
                        "select wallpaper,logo from setting where nama_instansi='"+tabMode.getValueAt(row,0).toString()+"'");
