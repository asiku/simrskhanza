...
public final class DlgPindahGudang extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Mutasi Antar Gudang Obat, Alkes & BHP Medis ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 70, 40))); // NOI18N
        ...
        DTPCari1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "03-06-2015" }));
        ...
        DTPCari2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "03-06-2015" }));
...
private void BtnCetakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCetakActionPerformed
       this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
        if(tabMode.getRowCount()==0){
            ...
            String tgl=" mutasibarang.tanggal between '"+Valid.SetTgl(DTPCari1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(DTPCari2.getSelectedItem()+"")+"' ";
            String  sql="select mutasibarang.kd_bangsaldari,(select nm_bangsal from bangsal where kd_bangsal=kd_bangsaldari) as dari ,"+
...
// TODO add your handling code here:
    ...
    */
    ...
    public void tampil(String order) {
        String tgl=" mutasibarang.tanggal between '"+Valid.SetTgl(DTPCari1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(DTPCari2.getSelectedItem()+"")+"' ";
        String  sql="select mutasibarang.kd_bangsaldari,(select nm_bangsal from bangsal where kd_bangsal=kd_bangsaldari),"+
    ...
    private void getData() {
        ...
        if(row!= -1){
            ...
            Valid.SetTgl(Tanggal,tabMode.getValueAt(row,7).toString());
        }
    }
