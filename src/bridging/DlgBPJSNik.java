 ...
 * @author dosen
 */
public final class DlgBPJSNik extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgBPJSNik(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgBPJSNik dialog = new DlgBPJSNik(new javax.swing.JFrame(), true);
